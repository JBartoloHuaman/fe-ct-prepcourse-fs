...
function crearGato(nombre, edad) {
   ...
   // Tu código:
   var new_obj = {}
   new_obj["nombre"]=nombre;
   new_obj["edad"]=edad;
   new_obj["meow"]=function(){return "Meow!"}
   return new_obj;
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for (var prop in objetoUsuario.posts){
      cont = cont + objetoUsuario.posts[prop].likes
   } 
   return cont;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function() {
      var precio_final;
      precio_final= objetoProducto.precio - (objetoProducto.precio*objetoProducto.porcentajeDeDescuento);
      return precio_final
   }
